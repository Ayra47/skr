...
return [
    ...
    */
    ...
    'alpha_dash' => 'Значение поля :attribute может содержать буквы, цифры, дефис и нижнее подчеркивание.',
    ...
    'max' => [
        ...
        'file' => 'Размер файла, указанный в поле :attribute, не может быть больше :max Кб.',
    ...
    'prohibited_if_accepted' => 'Значение поля :attribute запрещено, когда принято :other.',
    'prohibited_if_declined' => 'Значение поля :attribute запрещено, когда отклонено :other.',
    ...
    'required_array_keys' => 'Массив, указанный в поле :attribute, должен содержать записи для: :values.',
    ...
    'url' => 'Значение поля :attribute должно быть ссылкой.',
